...
$this->title = Yii::$app->params['system'] . ' | Retail Desk';
...
<div class="page-content container-fluid">
	<form action="<?php echo $baseUrl;?>/order/make" class="order-desk" method="post" >
		...
		<input type="hidden" name="retail_id" class="hidden-retail-id" value="<?php echo $retail['id']; ?>" />
				              	...
				              	<div class="container-fluid">
									  ...
									  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-10 custom-form">
							                  	<input type="number" class="form-control send-data empty-this customer-phone" name="customer_phone" placeholder="Phone" value="<?php if($retail['customer_phone'] != 0){echo $retail['customer_phone'];} ?>" />
							                </div>
						                </div>
					              		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-10 custom-form">
							                  	<input type="text" class="form-control send-data empty-this customer-name" name="customer_name" placeholder="Name" autocomplete="off" value="<?php if($retail['customer_name'] != null){echo $retail['customer_name'];} ?>" />
							                </div>
						                </div>

						                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-10 custom-form">
							                  	<input type="number" class="form-control send-data empty-this customer-pan" name="customer_pan" placeholder="Pan" value="<?php if($retail['customer_pan'] != 0){echo $retail['customer_pan'];} ?>" />
							                </div>
						                </div>
						                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-10 custom-form">
							                  	<input type="text" class="form-control send-data empty-this customer-address" name="customer_address" placeholder="Address" autocomplete="off" value="<?php if($retail['customer_address'] != null){echo $retail['customer_address'];} ?>" />
							                </div>
						                </div>
						            </form>
					            </div>
							            	...
							            	<div class="row">
							            		...
							            		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								            		...
								            		<div class="custom-button margin-top-10 pull-right btn-l991">
									            		...
									            		<a href="<?php echo $baseUrl;?>/retail/split-bill/?rid=<?php echo $retail['id']; ?>" class="btn btn-primary btn-lg split-bill" type="button">
					...
					<div class="panel-heading">
						<div class="panel-title-padding">
			          		<div class="row">
			          			...
			          			<div class="col-lg-4 col-md-4 col-sm-12">
			          				<h3 class="panel-title pull-right">Retail</h3>
			          			</div>
			          		</div>
			          	</div>
			        </div>
