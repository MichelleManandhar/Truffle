...
<div class="page-header padding-bottom-0">
    ...
    <!-- <div class="page-header-actions margin-top-10">
        <a href="<?php echo $baseUrl;?>/menu-category/" class="btn btn-icon btn-warning btn-round btn-big " data-toggle="tooltip" data-original-title="Go Back" data-placement="left">
                ...
                <div class="panel-body container-fluid">
                    <div class="row row-lg">
                        <div class="col-sm-12 col-lg-12 col-md-12">
                            <ul id="sortable" class="ui-sortable list-group list-group-gap" data-url="<?php echo $baseUrl;?>/menu-category/manage-order">
                                <?php if ($categories != null) : 
                                        foreach($categories as $category) : ?>
                                    <li class="list-group-item margin-top-5 pointer <?php echo ($category['is_active'] ==0) ? 'bg-inactive-color' : 'bg-active-color';?>" id="categories-<?php echo $category['id'];?>">
