				              	...
				              	<div class="container-fluid">
									  ...
									  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-10 custom-form">
							                  	<input type="number" class="form-control send-data empty-this customer-phone" name="customer_phone" placeholder="Phone" value="<?php if($delivery['customer_phone'] != 0){echo $delivery['customer_phone'];} ?>" />
							                </div>
						                </div>
					              		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-10 custom-form">
					                		...
					                		<?php 
					                			...
					                			/*
						                			...
						                			if($temp_items != null && $total > 0):
						                				...
						                				$grand_total 		= $gross_amount - $break_down_total['discount_amount'];
						                			endif;
					                			*/
					...
					<div class="panel-heading">
						<div class="panel-title-padding">
			          		<div class="row">
			          			...
			          			<div class="col-lg-4 col-md-4 col-sm-12">
			          				<h3 class="panel-title pull-right">Delivery</h3>
			          			</div>
			          		</div>
			          	</div>
			        </div>
                		...
                		<div class="col-sm-12 col-lg-5">
	                        <div class="form-group">
	                            ...
	                            <div class="row">
			                    	<div class="form-group">
			                    		<div class="col-lg-12">
			                    			<button type="submit" data-type="save" data-pay-type="credit" class="btn btn-primary btn-xs pull-right margin-bottom-5 ask-delivery-charge-credit padding-top-5 padding-bottom-5 padding-left-10 padding-right-10 full-width" style="display:none"><i class="icon fa-save"></i> Print&Close</button>
	                    					<button type="submit" data-type="print" data-pay-type="cash" class="btn btn-primary btn-xs pull-right margin-bottom-5 ask-delivery-charge-cash padding-top-5 padding-bottom-5 padding-left-10 padding-right-10 full-width"><i class="icon fa-print"></i> Print&Close</button>
			                            </div>
