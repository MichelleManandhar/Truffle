	...
	<div class="row">
		...
		<div class="col-md-9 col-lg-9 col-xs-12">
			<form action="<?php echo $baseUrl;?>/order/make-multiple" class="multiple-order-desk" method="post" >
				...
				<input type="hidden" class="customer-pax" name="customer_pax" value="<?php if($occupy['customer_pax'] != 0){echo $occupy['customer_pax'];} ?>" />
								...
								<div class="panel-heading">
									<div class="row">
										<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 margin-top-10">
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
												<div class="form-group form-material margin-bottom-3 custom-form">
													<input type="number" class="form-control empty-this customer-phone" placeholder="Customer Phone" data-bill='2' id="customer-phone-2" name="data[2][customer_phone]" autocomplete="off" />
												</div>
											</div>
											  
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								                <div class="form-group form-material margin-bottom-3 custom-form">
								                  	<input type="text" class="form-control empty-this customer-name" placeholder="Customer Name" name="data[2][customer_name]" id="customer-name-2" autocomplete="off" />
								                </div>
							                </div>
