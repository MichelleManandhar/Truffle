...
// $this->registerJsFile($baseUrl . '/assets/software/search-menu-item.js');
					              	...
					              	<form autocomplete="off">
										...
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-3 custom-form">
							                  	<input type="text" class="form-control send-data empty-this customer-phone" placeholder="Phone Number" name="customer_phone" autocomplete="off" value="<?php if($occupy['customer_phone'] != null){echo $occupy['customer_phone'];} ?>" />
							                </div>
						                </div>
						                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-3 custom-form">
										            			...
										            			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
										            				<div class="form-group margin-left-35 margin-bottom-5">
											            				<div class="input-group">
											                                ...
											                                <input type="number" name="discount_amount" class="form-control discount-amount" value="0" data-max="0">
										                                </div>
									                                </div>
										            			</div>
									            			</div>
					...
					<div class="panel-heading">
						<div class="panel-title-padding">
			          		<div class="row">
			          			...
			          			<div class="col-lg-4 col-md-4 col-sm-12">
			          				<?php if($table['name'] != null) : ?>
				          				<h4 class="pull-right margin-right-10">#<?php echo ucwords($table['name']); ?></h4>
				          			<?php endif; ?>
			          			</div>
			          		</div>
			          	</div>
                        ...
                        <div class="col-sm-12 col-lg-5">
	                        <div class="form-group">
	                            ...
	                            <div class="row">
			                    	<div class="form-group">
			                    		<div class="col-lg-12">
			                    			<button type="submit" data-loading-text="Sending..." data-type="print_and_close" class="btn btn-success btn-xs make-order padding-top-5 padding-bottom-5 padding-left-10 padding-right-10 margin-bottom-5 full-width"><i class="icon fa-print"></i> Print & Close</button>
                            				<button type="submit" data-loading-text="Sending..." data-type="save_and_close" class="btn btn-primary btn-xs credit-order padding-top-5 padding-bottom-5 padding-left-10 padding-right-10 margin-bottom-5 full-width" style="display:none"><i class="icon fa-save"></i> Print & Close</button>
			                            </div>

			                            <div class="col-lg-12">
			                    			<button type="submit" data-loading-text="Sending..." data-type="save" class="btn btn-primary btn-xs margin-right-5 margin-bottom-5 credit-order padding-top-5 padding-bottom-5 padding-left-10 padding-right-10 full-width" style="display:none"><i class="icon fa-save"></i> Print</button>
		                    				<button type="submit" data-loading-text="Sending..." data-type="print" class="btn btn-primary btn-xs margin-right-5 margin-bottom-5 make-order padding-top-5 padding-bottom-5 padding-left-10 padding-right-10 full-width"><i class="icon fa-print"></i> Print</button>
				                    	</div>
