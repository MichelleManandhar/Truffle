                        ...
                        /*if (collision($area, $(ui.helper))) {*/
                            ...
                            if (!check) { 
                                ...
                                if (data != false) { 
                                    ...
                                    $drag.prepend('<p class="drag-header cursor-move"><span>' + data.table_name + '</span></p>')
                                            .append('<div class="win-size-grip win-size-grip-tb win-size-grip-tb-'+data.id+'"></div>');
