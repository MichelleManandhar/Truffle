							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				              	<div class="container-fluid">
					              	<form autocomplete="off">
						                ...
						                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-10 custom-form">
							                  	<input type="number" class="form-control send-data empty-this customer-pan" name="customer_phone" placeholder="Phone" value="<?php if($retail['customer_phone'] != 0){echo $retail['customer_phone'];} ?>" />
							                </div>
						                </div>
						                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-10 custom-form">
