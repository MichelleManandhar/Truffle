...
$this->title = Yii::$app->params['system'] . ' | Delivery Order Desk';
...
<div class="page-content container-fluid">
	<form action="<?php echo $baseUrl;?>/order/make" class="order-desk" method="post" >
		...
		<input type="hidden" name="delivery_id" class="hidden-delivery-id" value="<?php echo $delivery['id']; ?>" />
					              	...
					              	<form autocomplete="off">
					              		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-10 custom-form">
							                  	<input type="text" class="form-control send-data empty-this customer-name" name="customer_name" placeholder="Name" autocomplete="off" value="<?php if($delivery['customer_name'] != null){echo $delivery['customer_name'];} ?>" />
							                </div>
						                </div>
						                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-10 custom-form">
							                  	<input type="number" class="form-control send-data empty-this customer-pan" name="customer_phone" placeholder="Phone" value="<?php if($delivery['customer_phone'] != 0){echo $delivery['customer_phone'];} ?>" />
							                </div>
						                </div>
						                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-10 custom-form">
							                  	<input type="number" class="form-control send-data empty-this customer-pan" name="customer_pan" placeholder="Pan" value="<?php if($delivery['customer_pan'] != 0){echo $delivery['customer_pan'];} ?>" />
							                </div>
						                </div>
						                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-10 custom-form">
							                  	<input type="text" class="form-control send-data empty-this customer-address" name="customer_address" placeholder="Address" autocomplete="off" value="<?php if($delivery['customer_address'] != null){echo $delivery['customer_address'];} ?>" />
							                </div>
						                </div>
						            </form>
					            </div>
            	...
            	<div class="row">
                	<form class="print-bill">
	                    ...
	                    <div class="form-group received-amount">
	                        ...
	                        <input type="number" placeholder="Received Amount" class="form-control amount-received" data-placement="left" data-toggle="tooltip" data-original-title="Received Amount">
	                    </div>
	                    ...
	                    <div class="form-group">
                            <button type="submit" data-type="save" data-pay-type="credit" class="btn btn-primary btn-xs pull-right margin-right-5 ask-delivery-charge-credit padding-top-5 padding-bottom-5 padding-left-10 padding-right-10" style="display:none"><i class="icon fa-save"></i> Print&Close</button>
	                    	<button type="submit" data-type="print" data-pay-type="cash" class="btn btn-primary btn-xs pull-right margin-right-5 ask-delivery-charge-cash padding-top-5 padding-bottom-5 padding-left-10 padding-right-10"><i class="icon fa-print"></i> Print&Close</button>
		            		...
		            		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			            		<div class="margin-top-10 pull-right">
			            			<div class="custom-button margin-top-10 pull-right btn-l991">
					            		...
					            		<button class="btn btn-primary btn-lg make-item-wise-credit" type="button">
...
<div class="modal modal-aside fade horizontal right modal-delivery-charge" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header theme-bg-color">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h4 class="modal-title color-white">Delivery Charge
					<span class="inv-required pull-right"></span>
                </h4>
            </div>
            ...
            <div class="modal-body padding-top-15 padding-bottom-15 padding-right-30 padding-left-30">
            	<!-- <div class="checkbox-custom checkbox-primary">
                    <input type="checkbox" id="inputChecked" class="apply-delivery-charge" name="apply_delivery_charge">
                    <label for="inputChecked">Apply Delivery Charge</label>
                </div>

                <div class="grey-divider margin-top-20 margin-bottom-20"></div> -->

                <form class="delivery-charge-form"> 
                	<input type="hidden" name="<?php echo $csrf_name; ?>" value="<?php echo $csrf_token; ?>" />
                	<input type="hidden" name="actual_delivery_charge_amount" class="actual-delivery-charge-amount">
                	<input type="hidden" name="delivery_charge_vat_amount" class="actual-delivery-charge-vat-amount">

                	<div class="form-group">
	                    <label class="control-label">Delivery Charge Amount</label>
	                    <input type="number" placeholder="Delivery Charge Amount" class="form-control delivery-charge-amount" data-placement="left" min="0" data-toggle="tooltip" data-original-title="Delivery Charge Amount" value="<?php echo ($delivery_charge_amount['value'] != null) ? $delivery_charge_amount['value'] : '0'; ?>">
	                </div>

	                <div class="form-group">
                        <button type="button" data-type="save" data-pay-type="credit" class="btn btn-primary btn-xs pull-right margin-right-5 make-credit-delivery-order padding-top-5 padding-bottom-5 padding-left-10 padding-right-10" style="display:none"><i class="icon fa-save"></i> Save</button>
                    	<button type="button" data-type="print" data-pay-type="cash" class="btn btn-primary btn-xs pull-right margin-right-5 make-cash-delivery-order padding-top-5 padding-bottom-5 padding-left-10 padding-right-10"><i class="icon fa-print"></i> Print </button>
                    	<button type="button" class="btn btn-default btn-xs pull-right margin-right-5 padding-top-5 padding-bottom-5 padding-left-10 padding-right-10" data-dismiss="modal">Cancel</button>
                    </div>
                </form>
            </div>
...
<script>
    ...
    var delivery_charge_vat_status  = '<?php echo $delivery_charge_vat_status['value'];?>';
