...
IF OBJECT_ID('booked_tables', 'U') IS NOT NULL 
...
IF OBJECT_ID('break_down_items', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('break_down_receipt', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('capacity', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('close_day_log', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('design_invoice', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('duplicate_bill', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('foc', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('foc_items', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('kot', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('kot_items', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('member_discount', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('member_order_category', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('member_privillege_threshold', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('member_report', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('menu_category', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('menu_item', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('menu_item_price', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('menu_stock_items', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('monthly_target', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('obstacles', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('occupy', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
INSERT INTO `occupy` VALUES("31","","0","","1","1","1","2018-05-15","16:51:24","2018-05-15","16:51:49","2018-05-15 16:51:24","2","0","0","0","0000-00-00 00:00:00","0","1","1");
...
IF OBJECT_ID('pick_up', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('printer_list', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('printer_lists', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('random', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('retail', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
INSERT INTO `retail` VALUES("1","","0","","","2018-04-16 17:17:35","2","1","0");
INSERT INTO `retail` VALUES("2","","0","","","2018-04-24 12:17:08","2","0","0");
...
IF OBJECT_ID('special_order_items', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('stock_entries', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('stock_items', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('table_details', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
INSERT INTO `table_details` VALUES("1","Table - 1","1","1","0","2017-12-12 12:23:30","2017-12-12 12:23:30","2","8.57775","3.05141","15.8556","15.3734","","0","0");
...
INSERT INTO `table_details` VALUES("3","Table - 3","3","1","0","0000-00-00 00:00:00","0000-00-00 00:00:00","2","0.0720626","37.7036","17.1115","7.54026","","0","0");
INSERT INTO `table_details` VALUES("4","Table - 4","4","1","0","2017-12-18 11:56:37","2017-12-18 11:56:37","2","0","3.87559","32.3391","7.54026","","0","0");
INSERT INTO `table_details` VALUES("5","Table - 5","5","1","0","0000-00-00 00:00:00","0000-00-00 00:00:00","2","24.9725","38.4444","15.6986","9.0776","","0","0");
...
INSERT INTO `table_details` VALUES("14","Table - 14","14","1","0","0000-00-00 00:00:00","0000-00-00 00:00:00","2","0.160139","55.9703","15.6986","7.54026","","0","0");
...
IF OBJECT_ID('take_away', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('temp_items', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('temp_order_list', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('tips', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('utensils_stock_entries', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
...
IF OBJECT_ID('utensils_stock_items', 'U') IS NOT NULL 
                        DROP TABLE dbo.Scores;
