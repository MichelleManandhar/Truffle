...
$this->registerJsFile($baseUrl . '/assets/software/order-v1.js');
...
$this->title = Yii::$app->params['system'] . ' | Order Desk';
...
<div class="page-content container-fluid">
	<form action="<?php echo $baseUrl;?>/order/make" class="order-desk" method="post" >
		...
		<input type="hidden" name="occupy_id" class="hidden-occupy-id" value="<?php echo $occupy['id']; ?>" />
		...
		<input type="hidden" name="table_id" class="hidden-table-id" value="<?php echo $occupy['table_id']; ?>" />
		<input type="hidden" name="floor_id" class="hidden-floor-id" value="<?php echo $occupy['floor_id']; ?>" />
					              	...
					              	<form autocomplete="off">
					              		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-3 custom-form">
							                  	<input type="text" class="form-control send-data empty-this customer-name" placeholder="Customer Name" name="customer_name" autocomplete="off" value="<?php if($occupy['customer_name'] != null){echo $occupy['customer_name'];} ?>" />
							                </div>
						                </div>
						                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-3 custom-form">
							                  	<input type="number" class="form-control send-data empty-this customer-pan" placeholder="PAN" name="customer_pan" value="<?php if($occupy['customer_pan'] != 0){echo $occupy['customer_pan'];} ?>" />
							                </div>
						                </div>
						                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-10 custom-form">
							                  	<input type="text" class="form-control send-data empty-this customer-address" placeholder="Address" name="customer_address" autocomplete="off" value="<?php if($occupy['customer_address'] != null){echo $occupy['customer_address'];} ?>" />
							                </div>
						                </div>
						                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-10 custom-form">
							                  	<input type="number" class="form-control send-data empty-this customer-pax" placeholder="PAX" name="customer_pax" autocomplete="off" value="<?php if($occupy['customer_pax'] != 0){echo $occupy['customer_pax'];} ?>" />
							                </div>
						                </div>
						            </form>
					            </div>
		                    ...
		                    <div class="tab-content padding-top-5">
			                    <div class="tab-pane active" id="order-list" role="tabpanel">
									                    ...
									                    ?>
									                    	<?php if($order_list['type'] != Yii::$app->params['item_type']['special']) : ?>
										                    	<tr class="listed-item <?php echo $order_list['slug']; ?>" data-list="order_list" data-item="<?php echo $order_list['slug']; ?>" data-price="<?php echo $order_list['price'] ?>" >
										                            <input type="hidden" name="items[<?php echo $selected_count; ?>][item]" class="item" value="<?php echo $order_list['name']; ?>">
									                        ...
									                        <?php else: ?>
									                        	<tr class="listed-item <?php echo $order_list['special_item_id']; ?>" data-list="order_list" data-item="<?php echo $order_list['special_item_id']; ?>" data-price="<?php echo $order_list['special_item_price'] ?>" >
										                            <input type="hidden" name="items[<?php echo $selected_count; ?>][item]" class="item" value="<?php echo $order_list['special_item_name']; ?>">
				                	...
				                	<span class="pull-right">
				                		<button type="button" data-loading-text="Sending..." id="send-kot-id" class="btn btn-sm btn-primary btn-outline send-kot margin-top-10">Send KOT</button>
			                		</span>
			                		<?php if(Yii::$app->session['eHhupx5UpkLZoXRP_cR1ozEVjY14zWOC0_user']->role == Yii::$app->params['user_role']['admin']) : ?>
				                		<span class="pull-left foc-create" <?php if($occupy['is_foc'] == Yii::$app->params['is_foc']['yes']) { echo 'style="display: none;"'; } ?> >
					                		<button type="button" class="btn btn-sm btn-primary btn-outline create-foc margin-top-10 pull-right">Create FOC</button>
				                		</span>
				                		<span class="pull-left foc-cancel" <?php if($occupy['is_foc'] == Yii::$app->params['is_foc']['no']) { echo 'style="display: none;"'; } ?> >
					                		<button type="button" class="btn btn-sm btn-primary btn-outline cancel-foc margin-top-10 pull-right">Cancel FOC</button>
				                		</span>
				                	<?php endif; ?>

				                	<button type="button" class="btn btn-sm btn-success pull-left btn-outline margin-left-10 margin-top-10 get-special-menu-item">Special Order</button>
			                    </div>
			                    ...
			                    <div class="tab-pane" id="all-list" role="tabpanel">
			                      	<div class="change-scroll-height <?php echo ($occupy['is_foc'] == Yii::$app->params['is_foc']['no']) ? 'scroll-height-200 slimscrollstart-position-200' : 'scroll-height-400 slimscrollstart-position-400'; ?>">
						              	<div class="example table-responsive margin-0">
							                <table class="table">
							                    <thead>
								                    <tr>
							                    ...
							                    if($temp_items != null):
								                    ...
								                    foreach ($temp_items as $temp_item): 
								                    	...
								                    	if($temp_item['type'] == Yii::$app->params['item_type']['regular']) : 
								                    		...
								                    		?>
								                    			<tr class="listed-item <?php echo $temp_item['slug']; ?>" data-list="all_list" data-item="<?php echo $temp_item['slug']; ?>" data-price="<?php echo $temp_item['price'] ?>">
										                            <input type="hidden" name="items[<?php echo $selected_count; ?>][item]" class="item" value="<?php echo $temp_item['name']; ?>">
									                    ...
									                    <?php else: ?>
									                    	<?php $total = $total + $temp_item['special_item_price'] * $temp_item['quantity']; ?>
								                    			<tr class="listed-item <?php echo $temp_item['special_item_id']; ?>" data-list="all_list" data-item="<?php echo $temp_item['special_item_id']; ?>" data-price="<?php echo $temp_item['special_item_price'] ?>">
										                            <input type="hidden" name="items[<?php echo $selected_count; ?>][item]" class="item" value="<?php echo $temp_item['special_item_name']; ?>">
			                		...
			                		<div class="panel-footer if-foc" <?php echo ($occupy['is_foc'] == Yii::$app->params['is_foc']['no']) ? '' : 'style="display : none;"' ?> >
				                		...
				                		<?php 
				                			...
				                			if($temp_items != null):
				                				...
				                				$break_down_total['discount_amount'];
				                			endif;*/
						            	...
						            	<div class="row">
									            				...
									            				<div class="row">
									            					...
									            					<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
									            						<span class="custom-touchspin">
									            							<input type="number" class="form-control discount zero-this" name="discount" data-plugin="TouchSpin" data-min="0" data-max="90" data-stepinterval="50" data-maxboostedstep="90" value="0" data-step="5" />
									            						</span>
									            					</div>
									            				</div>
									            			</div>
						            		...
						            		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							            		...
							            		<div class="custom-button margin-top-10 pull-right btn-l991">
								            		...
								            		<a href="<?php echo $baseUrl;?>/order/split-bill/?occid=<?php echo $occupy['id']; ?>" class="btn btn-primary btn-lg split-bill" type="button">
						            ...
						            <div class="panel-footer show-foc-button" <?php echo ($occupy['is_foc'] == Yii::$app->params['is_foc']['yes']) ? '' : 'style="display : none;"' ?> >
						            	<div class="row">
						            		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							            		<div class="margin-top-10 pull-right">
								            		<button class="btn btn-primary btn-lg save-foc" type="button">
            	...
            	<div class="row">
                	<form class="print-bill">
	                    ...
	                    <div class="form-group">
	                    	<div class="row">
	                    		<div class="col-md-6">
	                    			<button type="submit" data-loading-text="Sending..." data-type="print_and_close" class="btn btn-success btn-xs make-order padding-top-5 padding-bottom-5 padding-left-10 padding-right-10 margin-bottom-5"><i class="icon fa-print"></i> Print & Close</button>
	                            	<button type="submit" data-loading-text="Sending..." data-type="save_and_close" class="btn btn-primary btn-xs credit-order padding-top-5 padding-bottom-5 padding-left-10 padding-right-10 margin-bottom-5" style="display:none"><i class="icon fa-save"></i> Print & Close</button>
	                            </div>

	                            <div class="col-md-6">
	                    			<button type="submit" data-loading-text="Sending..." data-type="save" class="btn btn-primary btn-xs margin-right-5 credit-order padding-top-5 padding-bottom-5 padding-left-10 padding-right-10" style="display:none"><i class="icon fa-save"></i> Print</button>
		                    		<button type="submit" data-loading-text="Sending..." data-type="print" class="btn btn-primary btn-xs margin-right-5 make-order padding-top-5 padding-bottom-5 padding-left-10 padding-right-10"><i class="icon fa-print"></i> Print</button>
		                    	</div>
		                    </div>

		                    <div class="row">
	                    		<div class="col-md-6">
	                    			<button type="button" class="btn btn-danger btn-xs print-temporary-bill padding-top-5 padding-bottom-5 padding-left-10 padding-right-10"><i class="icon fa-print"></i> Print Temporary</button>
	                    		</div>

	                    		<div class="col-md-6">
	                    			<button type="button" class="btn btn-default btn-xs margin-right-5 padding-top-5 padding-bottom-5 padding-left-10 padding-right-10" data-dismiss="modal">Cancel</button>
                				</div>
                			</div>
	                    </div>
                    </form>
	            		...
	            		<div class="col-md-4 col-lg-4 col-sm-4">
					        ...
					        <form class="special-order-list-form">
						        ...
						        <div class="pull-right">
						        	<button type="submit" class="btn btn-primary send-selected-special-item-list">Send</button>
						        </div>
					        </form>
	            		</div>
            	...
            	<div class="modal-body">
	                ...
	                <div class="col-sm-12">
            			<div class="form-group debtor-name" hidden="hidden">
            				<label class="control-label">Debtor Name</label>	
                            <div class="input-group auto-parent">
                                <input type="text" name="dr[from]" placeholder="Debtor Name" class="form-control debtor-txt sub-input-group auto-show" data-placement="left" data-toggle="tooltip" data-original-title="Debtor Name" autocomplete="off">
                                <input type="hidden" name="dr[id]" class="auto-i hidden-debtor-id">
	                ...
	                <div class="col-sm-12">
                        <div class="form-group change-amount">
	                        ...
	                        <input type="number" readonly placeholder="Change" class="form-control amount-change" data-placement="left" data-toggle="tooltip" min="0" data-original-title="Change">
	                    </div>
                    </div>
            	</div>
		            		...
		            		<div class="mrg-top-15">
			            		...
			            		<div class="row">
			            			<div class="padding-top-5 form-group received-amount">
				            			...
				            			<div class="col-lg-5 col-md-6 col-sm-6 col-xs-6">
				            				<input type="number" placeholder="Received Amount" required class="form-control amount-received" data-placement="left" min="0" data-toggle="tooltip" data-original-title="Received Amount">
				            			</div>
			            			</div>
			            		</div>
			            		...
			            		<div class="row">
			            			<div class="padding-top-5 form-group change-amount">
				            			...
				            			<div class="col-lg-5 col-md-6 col-sm-6 col-xs-6">
				            				<input type="number" readonly placeholder="Change Amount" required class="form-control amount-change" data-placement="left" min="0" data-toggle="tooltip" data-original-title="Change Amount">
				            			</div>
			            			</div>
			            		</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body padding-top-15 padding-bottom-15 padding-right-30 padding-left-30">
	            <form class="kot-return-form" name="kot_return_form" action="<?php echo $baseUrl; ?>/kot/return" method="post">	
	                ...
	                <div class="form-group">
                		<button type="button" data-loading-text="Loading..." class="btn btn-primary btn-xm submit-return-kot-btn margin-top-50">Send</button>
                	</div>
	            </form>
            </div>
        </div>
