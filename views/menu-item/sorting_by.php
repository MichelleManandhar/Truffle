...
<div class="page-header padding-bottom-0">
    <h1 class="page-title">Manage Dispaly Order for <?php echo $category;?> : <span id="sorting-msg"></span></h1>
                        ...
                        <div class="col-sm-12 col-lg-12 col-md-12">
                            <ul id="sortable" class="ui-sortable list-group list-group-gap" data-url="<?php echo $baseUrl;?>/menu-item/manage-order">
                                <?php if ($items != null) :
                                    ...
                                    <li class="list-group-item margin-top-5 pointer <?php echo ($item['is_active'] ==0) ? 'bg-inactive-color' : 'bg-active-color';?>" id="item-<?php echo $item['id'];?>">
