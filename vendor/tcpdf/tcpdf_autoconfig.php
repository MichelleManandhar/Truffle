...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'aislogo.png')) {
		$tcpdf_header_logo = 'aislogo.png';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'AIS Website');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'AIS Website');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'AIS INVOICE');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by Accurate Informaiton System - www.ais.net.np");
}
