                    ...
                    <div class="">
                        <div class="row">
                            <div class="col-lg-6 col-md-4 col-sm-12">
                                <h4>STOCK : <?php echo ucwords( ($product!= null) ? $product['name'] : ''); ?></h4>
                            </div>
                        ...
                        <div class="row margin-top-10">
                            <div class="col-md-12">
                                <div class="table-parent">
                                    <table class="table table-hover dataTable table-striped width-full dtr-inline table-bordered with-export">
                                        <thead>
                                            <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="150">
                                                            ...
                                                            <?php elseif($row['stock_out'] > 0): ?>
                                                                Sales
                                                            <?php elseif($row['adjusted_quantity'] > 0 || $row['adjusted_quantity'] < 0): ?>
                                                                Adjustment
                                                            <?php endif; ?>
                                                        </td>
                                                        <td width="20">
