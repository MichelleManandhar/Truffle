					              	...
					              	<form autocomplete="off">
									  	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-10 custom-form">
							                  	<input type="number" class="form-control send-data empty-this customer-phone" name="customer_phone" placeholder="Phone" value="<?php if($take_away['customer_phone'] != 0){echo $take_away['customer_phone'];} ?>" />
							                </div>
						                </div>
					              		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							                <div class="form-group form-material margin-bottom-10 custom-form">
					...
					<div class="panel-heading">
						<div class="panel-title-padding">
			          		<div class="row">
			          			...
			          			<div class="col-lg-4 col-md-4 col-sm-12">
			          				<h3 class="panel-title pull-right">Take Away</h3>
			          			</div>
			          		</div>
			          	</div>
			        </div>
